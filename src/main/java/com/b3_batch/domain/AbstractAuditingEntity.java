 ...
 * information you use the AuitorAware<T> interface {@link com.b3_batch.security.SpringSecurityAuditorAware}
 * 
 * Finally, add the annotation @EnableJpaAuditing to have the configuration be loaded 
 * {@link com.b3_batch.config.DatabaseConfiguration}. Also be sure to add jadira.usertype.databaseZone
